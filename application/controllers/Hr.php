...
HTML;
    ...
    public function generate_payroll()
    {
        ...
        foreach ($roster as $staffId => $rosterData) {
            ...
            $daysAbsent     = 0;
            $paidLeaveDays  = 0; // L-marked days that are paid leave (counted as present for salary)
            $unpaidLeaveDays = 0; // L-marked days that are unpaid/LWP (deducted from salary)
            ...
            if (is_array($attendance) && isset($attendance[$staffId])) {
                ...
                for ($i = 0; $i < $len; $i++) {
                    ...
                    if ($ch === 'A') {
                        ...
                        // Determine if this leave day is paid or unpaid
                        if (isset($staffLwpSet[$dayNum])) {
                            $unpaidLeaveDays++;
                        } else {
                            $paidLeaveDays++;
