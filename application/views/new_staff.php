                        ...
                        <div class="nsa-grid nsa-grid-2">
                            ...
                            <div class="nsa-field nsa-col-2">
                                ...
                                <input type="text" id="street" name="street"
                                       class="nsa-input" placeholder="House no., Street name" required>
                            </div>

                            <div class="nsa-field">
                                <label>City <span class="req">*</span></label>
                                <input type="text" id="city" name="city"
                                       class="nsa-input" placeholder="City / District" required>
                            </div>

                            <div class="nsa-field">
                                <label>State <span class="req">*</span></label>
                                <input type="text" id="state" name="state"
                                       class="nsa-input" placeholder="State" required>
                            </div>

                            <div class="nsa-field">
                                <label>Postal Code <span class="req">*</span></label>
                                <input type="text" id="postal_code" name="postal_code"
                                       class="nsa-input" placeholder="6-digit PIN" required>
                            </div>
                        ...
                        <div class="nsa-grid nsa-grid-2">
                            ...
                            <div class="nsa-field">
                                ...
                                <input type="text" id="bank_name" name="bank_name"
                                       class="nsa-input" placeholder="e.g. State Bank of India" required>
                            </div>

                            <div class="nsa-field">
                                <label>Account Holder Name <span class="req">*</span></label>
                                <input type="text" id="account_holder" name="account_holder"
                                       class="nsa-input" placeholder="Name as on passbook" required>
                            </div>

                            <div class="nsa-field">
                                <label>Account Number <span class="req">*</span></label>
                                <input type="text" id="account_number" name="account_number"
                                       class="nsa-input" placeholder="Bank account number" required>
                            </div>

                            <div class="nsa-field">
                                <label>IFSC Code <span class="req">*</span></label>
                                <input type="text" id="bank_ifsc" name="bank_ifsc"
                                       class="nsa-input" placeholder="e.g. SBIN0001234" required>
                            </div>
                        ...
                        <div class="nsa-grid nsa-grid-2">
                            ...
                            <div class="nsa-field">
                                ...
                                <input type="number" id="allowances" name="allowances"
                                       class="nsa-input" placeholder="e.g. 5000" min="0" required>
                            </div>
                ...
                <div class="nsa-section" id="sec-docs">
                    ...
                    <div class="nsa-section-body">
                        <div class="nsa-grid nsa-grid-2">
                            ...
                            <!-- Staff Photo -->
                            <div class="nsa-field">
                                <label>Staff Photo <span class="req">*</span></label>
    ...
    <div class="nsa-modal-body">
        ...
        <div class="nsa-prev-section">
            ...
            <div class="nsa-prev-grid">
                ...
                <div class="nsa-prev-field"><div class="lbl">Category</div><div class="val" id="previewCategory"></div></div>
                <div class="nsa-prev-field"><div class="lbl">Religion</div><div class="val" id="previewReligion"></div></div>
...
function validateStaffForm() {
    ...
    if (!getValue('account_holder'))         showError('account_holder',         'Account holder name is required');
    ...
    if (!phonePattern.test(getValue('emergency_contact_phone')))
    ...
    if (!getValue('allowances') || isNaN(parseFloat(getValue('allowances'))))
        showError('allowances', 'Enter valid allowances');
...
function fillStaffPreviewData() {
    ...
    setText('previewReligion',   getValue('religion'));
