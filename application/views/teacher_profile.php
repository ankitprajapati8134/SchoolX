    ...
    <div class="tp-panel-wrap">
        ...
        <div class="tp-panel" id="tp-docs">
            ...
            <div class="tp-docs-grid">
                ...
                $du  = is_string($docUrl) ? htmlspecialchars($docUrl, ENT_QUOTES, 'UTF-8') : '';
                $ext = strtolower(pathinfo((string)$docUrl, PATHINFO_EXTENSION));
                ...
                <div class="tp-doc-card">
                    ...
                    <?php if ($du): ?>
                    <a href="<?= base_url('student/download_document?file=') . urlencode($docUrl) ?>"
...
.tp-stat-lbl {
    font-size: 10px; color: rgba(230,244,241,.5);
