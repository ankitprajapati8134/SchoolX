...
<div class="att-wrap">
    ...
    <div class="att-stats">
        <div class="att-stat-card present">
            ...
            <div class="att-stat-label">Students Present</div>
        </div>
        ...
        <div class="att-stat-card staff">
            ...
            <div class="att-stat-label">Staff Present</div>
        </div>
    </div>
...
(function(){
    ...
    function loadStats() {
        ...
        return postData('attendance/fetch_analytics', { month: monthName })
            .then(function(data) {
                if (!data || !data.status) {
                    throw new Error('Failed');
                }
                var analytics = data.analytics || [];
                var totalP = 0, totalA = 0, totalT = 0;
                ...
                setText('attStatPresent', totalP);
                setText('attStatAbsent', totalA);
                setText('attStatLate', totalT);
